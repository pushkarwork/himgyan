            ...
            <div className='md:w-[85%] w-[95%] mx-auto  rounded-3xl grid lg:grid-cols-[30%_70%] md:grid-cols-2 shadow-lg shadow-[#0000009d]'>
                ...
                <div className='w-full hidden md:block px-2 my-6 flex-col border-r border-[#8080804a]'>
                    ...
                    <div className='border-b mx-3 border-[#8080804a] mb-2 pb-4 grid  grid-cols-[15%_80%]'>
                        <div >
                            <svg width="40px" height="40px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#a30b29"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M9 11L11 13L15 9M19 10.2C19 14.1764 15.5 17.4 12 21C8.5 17.4 5 14.1764 5 10.2C5 6.22355 8.13401 3 12 3C15.866 3 19 6.22355 19 10.2Z" stroke="" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
                        </div>
